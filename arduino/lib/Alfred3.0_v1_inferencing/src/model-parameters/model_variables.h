...
const char* ei_classifier_inferencing_categories[] = { "falling", "lyingDown", "sittingDown", "standingUp" };
...
EI_CLASSIFIER_DSP_AXES_INDEX_TYPE ei_dsp_config_9_axes[] = { 0, 1, 2 };
...
const uint32_t ei_learning_block_4_inputs[2] = { 8,9 };
...
const ei_impulse_t impulse_656716_0 = {
    .project_id = 656716,
    .project_owner = "Max Mustermann",
    .project_name = "Alfred3.0 v1",
    .impulse_id = 1,
    .impulse_name = "Impulse #1",
    .deploy_version = 1,

    .nn_input_frame_size = 501,
    .raw_sample_count = 160,
    .raw_samples_per_frame = 3,
    .dsp_input_frame_size = 160 * 3,
    .input_width = 0,
    .input_height = 0,
    .input_frames = 0,
    .interval_ms = 25,
...
ei_impulse_handle_t impulse_handle_656716_0 = ei_impulse_handle_t( &impulse_656716_0 );
ei_impulse_handle_t& ei_default_impulse = impulse_handle_656716_0;

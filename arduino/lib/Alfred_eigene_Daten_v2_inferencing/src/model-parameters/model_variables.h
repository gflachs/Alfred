...
const char* ei_classifier_inferencing_categories[] = { "falling", "idle", "walking" };

EI_CLASSIFIER_DSP_AXES_INDEX_TYPE ei_dsp_config_786_axes[] = { 0, 1, 2 };
const uint32_t ei_dsp_config_786_axes_size = 3;
ei_dsp_config_spectral_analysis_t ei_dsp_config_786 = {
    786, // uint32_t blockId
...
ei_model_dsp_t ei_dsp_blocks[ei_dsp_blocks_size] = {
    { // DSP block 786
        ...
        (void*)&ei_dsp_config_786, // pointer to config struct
        ei_dsp_config_786_axes, // array of offsets into the input stream, one for each axis
        ei_dsp_config_786_axes_size, // number of axes
        1, // version
...
const uint32_t ei_learning_block_3_inputs[1] = { 786 };
...
const ei_impulse_t impulse_656847_0 = {
    .project_id = 656847,
    .project_owner = "Max Mustermann",
    .project_name = "Alfred_eigene_Daten v2",
    .impulse_id = 1,
    .impulse_name = "Impulse #1",
    .deploy_version = 10,

    .nn_input_frame_size = 1401,
...
ei_impulse_handle_t impulse_handle_656847_0 = ei_impulse_handle_t( &impulse_656847_0 );
ei_impulse_handle_t& ei_default_impulse = impulse_handle_656847_0;
